...
class ApiController extends Controller
{
    ...
    public function read(Request $request) {
        ...
        if ($validation->passes()) {
            return $this->_getDataForDevice($request->device);
        }
    ...
    public function getTemperature(Request $request) {
        ...
        if ($validation->passes()) {
            ...
            //print_r($data['sensors'][1]['value']);
            //print_r($data['sensors'][2]['value']);
            //print_r($data['sensors'][3]['value']);
            //print_r($data['sensors'][4]['value']);

            return response()->json(['temperature' => $data['sensors'][1]['value']]);
        }
    ...
    public function getPressure(Request $request) {
        ...
        if ($validation->passes()) {
            $data = $this->_getDataForDevice($request->device);
            return response()->json(['pressure' => $data['sensors'][3]['value']]);
        }
    ...
    public function getBatteryStatusLevel(Request $request) {
        error_log("get batteryLevel");
        ...
        if ($validation->passes()) {
            $data = $this->_getDataForDevice($request->device);
            return response()->json(['batteryLevel' => $data['sensors'][4]['value']]);
        }
